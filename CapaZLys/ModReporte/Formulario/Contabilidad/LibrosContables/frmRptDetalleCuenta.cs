...
{
    public partial class frmRptDetalleCuenta : FiltroLys.ZLys.Controles.Formulario.frmReporte
    {
        #region "==EventForm=="

        public frmRptDetalleCuenta()
        {
            InitializeComponent();
        }

        private void frmRptDetalleCuenta_Load(object sender, EventArgs e)
        {
            fxCargarCombos();
            fxCargarCombosXCia();
            fxSetearInicio();
        ...
        private void fxSetearInicio() {
            ...
            String sPer = fnGeneral.PeriodoAnt(DateTime.Today);
        ...
        public override void ue_Buscar() {
            ...
            try{
                ...
                xPrmR.AddParametro(new entRepParam() { Propiedad = "Ordenar", Valor = "T" });
                xPrmR.AddParametro(new entRepParam() { Propiedad = "Pendiente", Valor = "T" });
                xPrmR.AddParametro(new entRepParam() { Propiedad = "Moneda", Valor = sMon });                
                xPrmR.AddParametro(new entRepParam() { Propiedad = "CCosto", Valor = "T" });
                xPrmR.AddParametro(new entRepParam() { Propiedad = "CuentaDestino", Valor = "T" });

                rpt_DetalleVouchers oRpt = new rpt_DetalleVouchers();
