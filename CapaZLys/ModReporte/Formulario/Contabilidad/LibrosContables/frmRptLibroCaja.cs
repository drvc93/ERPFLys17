...
{
    public partial class frmRptLibroCaja : FiltroLys.ZLys.Controles.Formulario.frmReporte
    {
        #region "==EventForm=="

        public frmRptLibroCaja()
        {
            InitializeComponent();
        }

        private void frmRptLibroCaja_Load(object sender, EventArgs e)
        {
            fxCargarCombos();
            fxCargarCombosXCia();
            fxSetearInicio();
        ...
        public override void ue_Buscar() {
            ...
            try{
                ...
                rpt_LibroCaja oRpt = new rpt_LibroCaja();
