...
namespace FiltroLys.ZLys.ModReporte.Formulario.Contabilidad.Estadistico
{
    public partial class frmRptBalanceComp : FiltroLys.ZLys.Controles.Formulario.frmReporte
    {
        ...
        private void fxCargarCombos()
        {
            ...
            //Tipo BC
            cmbTipoBC.Properties.DataSource = fnListasDat.ListRptBCTipo();
            cmbTipoBC.Properties.DisplayMember = "Nombre";
            cmbTipoBC.Properties.ValueMember = "Codigo";
            
            //Version
            cmbFormato.Properties.DataSource = fnListasDat.ListRptBCFormato();
        ...
        private void fxSetearInicio() {
            ...
            cmbTipoBC.EditValue = fnConst.RepBCTipoMayCod;
            cmbFormato.EditValue = fnConst.RepBCFormatoSAcumCod;
        }
        ...
        public override void ue_Buscar() {
            ...
            String sTBC = cmbTipoBC.EditValue.ToString();
            String sFor = cmbFormato.EditValue.ToString();
            ...
            try{
                ...
                xPrmR.AddParametro(new entRepParam() { Propiedad = "TipoBC", Valor = sTBC });
                xPrmR.AddParametro(new entRepParam() { Propiedad = "TipoCuenta", Valor = sTip });

                if (sTBC.Equals(fnConst.RepBCTipoMayCod) && sFor.Equals(fnConst.RepBCFormatoSAcumCod)) {
                    rpt_BalComprobMayF1 oRpt = new rpt_BalComprobMayF1();
                ...
                if (sTBC.Equals(fnConst.RepBCTipoCtaCod) && sFor.Equals(fnConst.RepBCFormatoSAcumCod)){
                    rpt_BalComprobCtaF1 oRpt = new rpt_BalComprobCtaF1();
                    oRpt.GenerarReport(ref xPrmR);
                    dvReport.DocumentSource = oRpt;
                    FnReportW = xPrmR;
                    oRpt = null;
                ...
                if (sTBC.Equals(fnConst.RepBCTipoMayCod) && sFor.Equals(fnConst.RepBCFormatoSalIniCod)){
                    rpt_BalComprobMayF2 oRpt = new rpt_BalComprobMayF2();
                    oRpt.GenerarReport(ref xPrmR);
                    dvReport.DocumentSource = oRpt;
                    FnReportW = xPrmR;
                    oRpt = null;
                ...
                if (sTBC.Equals(fnConst.RepBCTipoCtaCod) && sFor.Equals(fnConst.RepBCFormatoSalIniCod)){
                    rpt_BalComprobCtaF2 oRpt = new rpt_BalComprobCtaF2();
                    oRpt.GenerarReport(ref xPrmR);
                    dvReport.DocumentSource = oRpt;
                    FnReportW = xPrmR;
                    oRpt = null;
