    ...
    public class datTipoGasto
    {
        public static DataTable ListaFormID()
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoGasto.QR_ListaFormID();
        ...
        public static DataTable GetFormID(String TipoGasto)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoGasto.QR_GetFormID();
                Cmd.CommandType = CommandType.Text;
        ...
        public static DataTable ListaCombo(String Estado)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoGasto.QR_ListaCombo();
                Cmd.CommandType = CommandType.Text;
        ...
        public static DataTable ListaSearch(String TipoGasto, String Descripcion, String Estado)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoGasto.QR_ListaSearch();
                Cmd.CommandType = CommandType.Text;
                Cmd.Parameters.Add(new SqlParameter("@TipoGasto", SqlDbType.VarChar)).Value = TipoGasto;
        ...
        public static entErrores MantFormID(entTipoGasto Data)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion())){
                ...
                try{
                    ...
                    Cmd.CommandText = tsqTipoGasto.QR_MantFormID(Data.OperMantenimiento);
