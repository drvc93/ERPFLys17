    ...
    public class datTipoActivo
    {
        public static DataTable ListaFormID()
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoActivo.QR_ListaFormID();
        ...
        public static DataTable GetFormID(String TipoActivo)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoActivo.QR_GetFormID();
                Cmd.CommandType = CommandType.Text;
        ...
        public static DataTable ListaCombo(String Estado)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoActivo.QR_ListaCombo();
                Cmd.CommandType = CommandType.Text;
        ...
        public static DataTable ListaSearch(String TipoActivo, String Descripcion, String Estado)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = tsqTipoActivo.QR_ListaSearch();
                Cmd.CommandType = CommandType.Text;
                Cmd.Parameters.Add(new SqlParameter("@TipoActivo", SqlDbType.VarChar)).Value = TipoActivo;
        ...
        public static entErrores MantFormID(entTipoActivo Data)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion())){
                ...
                try{
                    ...
                    Cmd.CommandText = tsqTipoActivo.QR_MantFormID(Data.OperMantenimiento);
