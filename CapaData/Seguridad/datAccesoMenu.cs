    ...
    public class datAccesoMenu{
        ...
        public static DataTable ListaFormID()
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = fnQuery.tsqAccesoMenuSys;
        ...
        public static DataTable GetFormID(String Usuario,String Aplicacion, String Niveles)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                ...
                Cmd.Parameters.Add(new SqlParameter("@Niveles", SqlDbType.VarChar)).Value = Niveles;
        ...
        public static DataTable ListaUsuarioApp(String Usuario, String Aplicacion)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                ...
                Cmd.CommandType = CommandType.StoredProcedure;
                Cmd.Parameters.Add(new SqlParameter("@Accion", SqlDbType.VarChar)).Value = fnConst.OperaAccionLst;
                Cmd.Parameters.Add(new SqlParameter("@Opcion", SqlDbType.VarChar)).Value = "USUAPP";
                Cmd.Parameters.Add(new SqlParameter("@Usuario", SqlDbType.VarChar)).Value = Usuario;
                Cmd.Parameters.Add(new SqlParameter("@Aplicacion", SqlDbType.VarChar)).Value = Aplicacion;
        ...
        public static entErrores MantFormID(entAccesoMenu Data)
        {
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion())){
                ...
                try{
                    ...
                    Cmd.Parameters.Add(new SqlParameter("@Niveles", SqlDbType.VarChar)).Value = Data.Niveles;
                    Cmd.Parameters.Add(new SqlParameter("@Acceso", SqlDbType.VarChar)).Value = Data.Acceso;
                    Cmd.Parameters.Add(new SqlParameter("@Nuevo", SqlDbType.VarChar)).Value = Data.Nuevo;
                    Cmd.Parameters.Add(new SqlParameter("@Modificar", SqlDbType.VarChar)).Value = Data.Modificar;
                    Cmd.Parameters.Add(new SqlParameter("@Eliminar", SqlDbType.VarChar)).Value = Data.Eliminar;
                    Cmd.Parameters.Add(new SqlParameter("@Otros", SqlDbType.VarChar)).Value = Data.Otros;
        ...
        public static DataTable ListaMenuMaestro(String Usuario)
        {
            DataTable dt = new DataTable();
            SqlCommand Cmd = new SqlCommand();
            ...
            using (SqlConnection Cnx = new SqlConnection(Configuracion.getCadConexion()))
            {
                Cmd.Connection = Cnx;
                Cmd.Connection.Open();
                Cmd.CommandText = fnQuery.tsqAccesoListMaestroSys;
                Cmd.CommandType = CommandType.StoredProcedure;
                Cmd.Parameters.Add(new SqlParameter("@Usuario", SqlDbType.VarChar)).Value = Usuario;
